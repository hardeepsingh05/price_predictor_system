...
# Subclasses must implement the method to identify and visualize missing values
class MissingValuesAnalysisTemplate(ABC):
    ...
    def visualize_missing_values(self, df: pd.DataFrame):
        ...
        Returns:
        None: This method should create a heapmap of missing values.
        """
        pass
...
class SimpleMissingValuesAnalysis(MissingValuesAnalysisTemplate):
    ...
    def visualize_missing_values(self, df: pd.DataFrame):
        ...
        Returns:
        None: Displays a heapmap of missing values.
        """
