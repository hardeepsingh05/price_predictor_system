...
def model_building_step(
    ...
    y_train (pd.Series): The training data target feature.
    ...
    logging.info(f"Categorical Columns in X_train: {categorical_cols.tolist()}")
    logging.info(f"Numerical Columns in X_train: {numerical_cols.tolist()}")

    # Define preprocessing for categorical and numerical features
    numerical_transformer = SimpleImputer(strategy = "mean")   # Imputing generated NaN values in any column which may come up while passing data through the different steps of preprocessing.
