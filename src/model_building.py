...
# Abstract Base class for Model Buidling Strategy
class ModelBuildingStrategy(ABC):
    ...
    def build_and_train_model(self, X_train: pd.DataFrame, y_train: pd.Series) -> RegressorMixin:
        ...
        y_train (pd.Series): The training data label/target.
...
class ModelBuilder:
    def __init__(self, strategy: ModelBuildingStrategy):
        """
        Initialize ModelBuilder with a specific model building strategy.

        Parameters:
        strategy (ModelBuildingStrategy): The strategy to be used for model buiding.
        """
